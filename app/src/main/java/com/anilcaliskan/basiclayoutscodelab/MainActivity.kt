package com.anilcaliskan.basiclayoutscodelab
...
import com.anilcaliskan.basiclayoutscodelab.ui.theme.MySootheTheme
import java.util.*
...
private fun SootheBottomNavigation(modifier: Modifier = Modifier) {
    BottomNavigation(
        ...
        BottomNavigationItem(
            icon ={
                Icon(
                    painter = painterResource(id=R.drawable.spa), null,
...
fun FavoriteCollectionsGridPreview() {
    MySootheTheme { FavoriteCollectionsRow() }
}
